...
public static class ShareError
{
    ...
    public static ShockersNotFoundProblem ShareCreateShockerNotFound(IEnumerable<Guid> missingShockers) => new("Share.Request.Create.ShockerNotFound", "One or multiple of the provided shocker's were not found or do not belong to you", missingShockers, HttpStatusCode.NotFound);
