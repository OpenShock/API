...
public interface IAccountService
{
    ...
    /// <returns></returns>
    public Task<OneOf<Success<string>, AccountDeactivated, NotFound>> Login(string usernameOrEmail, string password, LoginContext loginContext, CancellationToken cancellationToken = default);
    ...
    /// <param name="email"></param>
    /// <returns></returns>
    public Task<OneOf<Success, TooManyPasswordResets, AccountDeactivated, NotFound>> CreatePasswordReset(string email);
    ...
    /// <returns></returns>
    public Task<OneOf<Success, NotFound, AccountDeactivated, SecretInvalid>> PasswordResetComplete(Guid passwordResetId, string secret, string newPassword);
    ...
    public Task<OneOf<Success, UsernameTaken, UsernameError, RecentlyChanged, AccountDeactivated, NotFound>> ChangeUsername(Guid userId, string username, bool ignoreLimit = false);
    ...
    /// <param name="newPassword"></param>
    /// <returns></returns>
    public Task<OneOf<Success, AccountDeactivated, NotFound>> ChangePassword(Guid userId, string newPassword);
}
