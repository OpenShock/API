...
export function EmailChangeNotice(props: EmailChangeNoticeProps) {
  return (
    <Layout heading="Email change requested">
      ...
      <Paragraph>
        The change is <strong>not yet applied</strong>. It will only take
        effect once the new address is verified via the link sent to it.
      </Paragraph>
      <Paragraph>If this was you, no action is needed.</Paragraph>
      <Paragraph>
